-- On new entity, reinitialize libraries.
library IEEE;
...
architecture beh_arch of memory is
    ...
    X"5260", X"54A0", X"A20A", X"05FE", X"A409", X"14BF", X"0403", X"A209", -- NEW addr 0x0500 to 0x0507
    X"B206", X"0FF6", X"A205", X"B203", X"0FF3", X"FE20", X"FE22", X"FE26", -- NEW addr 0x0508 to 0x050f
    X"FE34", X"FE35",X"2001", X"c000", X"0916", X"000a", X"0020", X"002a",  -- NEW addr 0x0510 to 0x0517
